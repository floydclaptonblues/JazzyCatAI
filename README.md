...
## May 2026 content update

- `data/jazzycat-current-schedule.json` now contains the May 2026 BMC schedule in the `schedule` array expected by `jazzycat.html`.
- `data/jazzycat-artists.json` now contains the May 2026 artist roster, preserving existing verified/provisional genre metadata and marking new artists for review.
- `jazzycat.html` now displays full time ranges when answering schedule questions and rendering schedule cards.
